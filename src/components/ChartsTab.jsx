...
function CategoryModal({ category, type, color, entries, onClose }) {
  ...
  const monthData = useMemo(() => {
    ...
    const months = Array.from({ length: 12 }, (_, i) => {
      ...
      // ── FIX: "numeric" year so it shows "Apr 2026" not "Apr 26" ──
...
export default function ChartsTab({ userId }) {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setEntries(e); setExpCats(ec); setIncCats(ic);
      ...
      <div className="two-col">
        ...
        <div className="card">
          ...
          <div style={{ marginTop: 20, borderTop: "1px solid var(--border)", paddingTop: 16 }}>
            ...
            <CategoryList
              entries={entries} type="income" categories={incCats}
              chartMonth={chartMonth} onCategoryClick={openModal}
            />
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div style={{ marginTop: 20, borderTop: "1px solid var(--border)", paddingTop: 16 }}>
            ...
            <CategoryList
              entries={entries} type="expense" categories={expCats}
              chartMonth={chartMonth} onCategoryClick={openModal}
            />
          </div>
        </div>
