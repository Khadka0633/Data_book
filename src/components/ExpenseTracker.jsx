    ...
    >
      ...
      <div style={{ padding: "0 20px" }}>
        ...
        <div
          ...
          onClick={() =>
            document.getElementById("transfer-date-input").showPicker?.()
          }
        >
          <span
            style={{
        ...
        <div style={{ paddingTop: 24 }}>
          ...
          >
            {saving
              ? "Transferring..."
              : `Transfer${form.amount ? ` रु${form.amount}` : ""}`}
          </button>
        </div>
      </div>
                  ...
                  style={{
                    ...
                    background:
                      form.fromId === a.id
                        ...
                        : "var(--surface-2)",
                    color:
                      form.fromId === a.id ? "var(--accent)" : "var(--text)",
                    textAlign: "center",
                  }}
                >
                  {a.icon} {a.name}
                  ...
                  style={{
                    ...
                    background:
                      form.toId === a.id
                        ? "rgba(99,102,241,0.15)"
                        : "var(--surface-2)",
                    color: form.toId === a.id ? "var(--accent)" : "var(--text)",
                    textAlign: "center",
                  }}
                >
                  {a.icon} {a.name}
    ...
    >
      ...
      <div style={{ padding: "0 20px" }}>
        ...
        <div
          ...
          onClick={() =>
            document.getElementById("edit-transfer-date").showPicker?.()
          }
        >
          <span
            style={{
                  ...
                  style={{
                    ...
                    background:
                      fromId === a.id
                        ? "rgba(99,102,241,0.15)"
                        : "var(--surface-2)",
                    color: fromId === a.id ? "var(--accent)" : "var(--text)",
                    textAlign: "center",
                  }}
                >
                  {a.icon} {a.name}
                  ...
                  style={{
                    ...
                    background:
                      toId === a.id
                        ? "rgba(99,102,241,0.15)"
                        : "var(--surface-2)",
                    color: toId === a.id ? "var(--accent)" : "var(--text)",
                    textAlign: "center",
                  }}
                >
                  {a.icon} {a.name}
